...
function Table({ className, ...props }: React.ComponentProps<"table">) {
    return (
        // wrapper intentionally does NOT create a vertical scroll container so sticky
        // headers inside <th> can attach to the page-level scroll container.
        <div data-slot="table-container" className="relative w-full overflow-visible">
            <table
                data-slot="table"
